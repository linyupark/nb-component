...
class Marquee {
    ...
    render() {
        return h("div", { class: `marquee ${this.styleId}` }, this.items.map((item, i) => {
            return h("a", { href: item.link, class: `item ${i === 0 ? this.rollupClassName : ''}` }, this.styleId === 'tow-row-66h' && [h("div", { class: "text" }, item.text), h("div", { class: "time" }, item.time)]);
        }));
    }
    componentDidLoad() {
    ...
    static get style() { return ".marquee.tow-row-66h {\n  height: 0.88rem;\n  overflow: hidden;\n  font-size: 0.32rem;\n  line-height: 1;\n}\n.marquee.tow-row-66h .item {\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  height: 0.426666666666667rem;\n  margin-bottom: 0.106666666666667rem;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n          -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: justify;\n  -webkit-justify-content: space-between;\n          -ms-flex-pack: justify;\n          justify-content: space-between;\n  -webkit-transition: 0.2s all;\n  transition: 0.2s all;\n  text-decoration: none;\n  overflow: hidden;\n}\n.marquee.tow-row-66h .item .text {\n  width: 6.133333333333334rem;\n  height: 0.32rem;\n  color: #595959;\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  -webkit-line-clamp: 1;\n  line-height: 1;\n  overflow: hidden;\n}\n.marquee.tow-row-66h .item .time {\n  color: #8c8c8c;\n}\n.marquee.tow-row-66h .item.fadeOut {\n  -webkit-animation: fadeout 0.2s;\n          animation: fadeout 0.2s;\n}\n\@-webkit-keyframes fadeout {\n  from {\n    height: 0.426666666666667rem;\n    opacity: 1;\n    margin-bottom: 0.106666666666667rem;\n  }\n  to {\n    height: 0;\n    margin-bottom: 0;\n    opacity: 0;\n  }\n}\n\@keyframes fadeout {\n  from {\n    height: 0.426666666666667rem;\n    opacity: 1;\n    margin-bottom: 0.106666666666667rem;\n  }\n  to {\n    height: 0;\n    margin-bottom: 0;\n    opacity: 0;\n  }\n}"; }
}
  ...
  <nb-badge count={6} bgColor="blue">
    ...
    'nb-pull-to-do': [
        h("div", { class: "wrapper", style: {
            ...
            h("nb-pull-to-do", { wrapperSelector: ".wrapper", contentSelector: ".main", onRefresh: (ev) => {
                    console.log('刷新开始');
                    setTimeout(() => {
                ...
                h("div", { slot: "refresh-loading" }, "\u52A0\u8F7D\u4E2D"),
                h("div", { slot: "refresh" }, "\u4E0B\u62C9\u5237\u65B0"),
                h("div", { class: "main", slot: "main", style: {
                        overflowX: 'hidden',
                        background: '#fff',
                        padding: '20px'
                    } },
                ...
                h("div", { slot: "more" }, "\u4E0A\u62C9\u52A0\u8F7D\u66F4\u591A"),
                h("div", { slot: "more-loading" }, "\u52A0\u8F7D\u4E2D"))),
        h("div", { class: "lang" }, "React"),
        h("nb-code-highlight", { code: `
    <div
      class="wrapper"
        ...
        h("div", { class: "wrapper", ref: ev => (refTarget.affix = ev), style: {
            ...
            h("div", { class: "content", style: {
                ...
                h("nb-affix", { onChange: ({ detail }) => {
                    ...
                    }, offset: 0, relativeSelector: ".wrapper" },
