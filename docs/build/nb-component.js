...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "NbComponent","nb-component",0,"nb-component.core.js","es5-build-disabled.js","hydrated","nb-actionsheet,nb-affix,nb-badge,nb-code-highlight,nb-list,nb-list-item,nb-pagination,nb-playground,nb-pull-to-do",HTMLElement.prototype);